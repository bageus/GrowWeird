...
func _test_scene_hud_contract() -> void:
	...
	_expect(not shop_scene.contains('name="Balance"') and not shop_script.contains("BalanceFrame") and shop_scene.contains("anchor_top = 0.2") and shop_script.contains("warm_hud_style(8, 26") and shop_script.contains("border_width_left = 7") and FileAccess.get_file_as_string("res://src/presentation/main/main_screen.gd").count("shop_container.visible") == 1, "shop HUD: redundant balance, thin frames, unsafe top offset, or background Cancel is present")
	...
	_expect(shop_script.contains("UiAtlas.coin_texture()") and shop_script.contains("TransactionDialogVisual.configure") and FileAccess.get_file_as_string("res://src/presentation/ui/transaction_dialog_visual.gd").contains("UiAtlas.configure_button"), "shop HUD: atlas Buy and close controls are missing")
...
func _test_inventory_hud_contract() -> void:
	...
	_expect(FileAccess.get_file_as_string("res://src/presentation/inventory/inventory_item_dialogs.gd").contains('actions.add_theme_stylebox_override(&"panel", StyleBoxEmpty.new())') and FileAccess.get_file_as_string("res://src/presentation/inventory/inventory_item_dialogs.gd").contains("TransactionDialogVisual.configure") and FileAccess.get_file_as_string("res://src/presentation/ui/transaction_dialog_visual.gd").contains('title.text = String(mode).to_upper()') and FileAccess.get_file_as_string("res://src/presentation/ui/transaction_dialog_visual.gd").contains("Vector2(486.0, 480.0)") and FileAccess.get_file_as_string("res://src/presentation/ui/transaction_dialog_visual.gd").contains("configure_transaction_total") and FileAccess.get_file_as_string("res://src/presentation/ui/transaction_dialog_visual.gd").contains("Rect2(438.0, -10.0, 60.0, 60.0)") and FileAccess.get_file_as_string("res://src/presentation/ui/transaction_dialog_visual.gd").contains('_configure_quantity_button(nodes["minus"] as Button, "−")') and not FileAccess.get_file_as_string("res://src/presentation/ui/transaction_dialog_visual.gd").contains("HUD_QUANTITY") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("class CoinFace") and not FileAccess.get_file_as_string("res://src/presentation/shop/shop_panel.gd").contains('register(%Confirm, "confirm")'), "inventory HUD: item action menu retained its dark panel")
	...
	_expect(controls_scene.contains("layout_id = &\"wallet\"\ndrag_handle_height = 120.0\nallow_scaling = true") and controls_scene.contains("z_index = 200") and FileAccess.get_file_as_string("res://src/presentation/main/energy_hud.tscn").contains("z_index = 200"), "balance HUD: coin and energy blocks must be scalable and above dialogs")
	...
	_expect(draggable_script.contains("KEY_CTRL") and draggable_script.contains("MOUSE_BUTTON_WHEEL_UP") and draggable_script.contains("scale_committed.emit") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.gd").contains('configure_topup_card(%Coin1000, "1000 Coins", UiAtlas.energy_coin_icon(1, 4))') and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.gd").contains('configure_topup_card(%Energy30, "30 Energy", UiAtlas.energy_coin_icon(3, 4))') and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("static func configure_topup_card") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").count('type="Panel" parent="Window/Lots/') == 4 and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").count('type="Panel" parent="Window/Lots/') == 3 and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").count("anchors_preset = 7") == 4 and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").count("anchors_preset = 7") == 3 and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("button.icon_alignment = HORIZONTAL_ALIGNMENT_CENTER") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").contains("separation = 8") and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").contains("separation = 8") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("button.clip_contents = true") and not FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("COIN_LOTS") and not FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("ENERGY_LOTS") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains('button.text = "FREE"') and not FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("shadow_offset_x") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").contains("Vector2(195, 322)") and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").contains("Vector2(213.2, 322)") and not FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").contains("Advertising bonus") and FileAccess.get_file_as_string("res://src/presentation/main/energy_hud.tscn").contains("Next energy in 02:00") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").contains("visible = false\nlayout_mode = 0\noffset_left = 250.0") and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").contains("visible = false\nlayout_mode = 0\noffset_left = 150.0"), "wallet HUD: stable hover, visible price content, hidden balances, and corrected lot spacing are required")
