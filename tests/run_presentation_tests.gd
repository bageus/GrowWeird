...
func _test_inventory_hud_contract() -> void:
	...
	_expect(main_screen_script.contains("func _input(event: InputEvent)") and main_screen_script.contains("cancelable_menu_contains_global_point") and main_screen_script.contains("set_input_as_handled"), "context menus: outside click must cancel without activating the scene below")
