...
func _test_scene_hud_contract() -> void:
	...
	_expect(hud_text.contains("OffersPanel") and hud_text.contains("RefreshOffer") and hud_text.contains("SkipOffer") and hud_text.contains("AdOffer"), "scene HUD: fertilizer modal needs refresh, skip, and rewarded-ad controls")
