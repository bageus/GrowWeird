...
func _test_inventory_hud_contract() -> void:
	...
	var atlas_script := FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd")
	var wallet_topup_script := FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.gd")
	var energy_topup_script := FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.gd")
	_expect(atlas_script.contains("energycoin_icon.png") and atlas_script.contains("ENERGY_COIN_CELL := 256.0") and atlas_script.contains("energy_coin_icon(2, 4) if energy else energy_coin_icon(2, 3)"), "balance HUD: coin and energy icons must use atlas frames 2-3 and 2-4")
	_expect(wallet_topup_script.contains("energy_coin_icon(2, 1)") and wallet_topup_script.contains("energy_coin_icon(1, 2)") and wallet_topup_script.contains("energy_coin_icon(1, 1)") and wallet_topup_script.contains("energy_coin_icon(1, 4)"), "wallet HUD: every coin lot must use its requested energycoin atlas frame")
	_expect(energy_topup_script.contains("energy_coin_icon(3, 3)") and energy_topup_script.contains("energy_coin_icon(3, 2)") and energy_topup_script.contains("energy_coin_icon(3, 4)"), "energy HUD: every energy lot must use its requested energycoin atlas frame")
	_expect(draggable_script.contains("KEY_CTRL") and draggable_script.contains("MOUSE_BUTTON_WHEEL_UP") and draggable_script.contains("scale_committed.emit") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.gd").contains('configure_topup_card(%Coin1000, "1000 Coins", UiAtlas.energy_coin_icon(1, 4))') and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.gd").contains('configure_topup_card(%Energy30, "30 Energy", UiAtlas.energy_coin_icon(3, 4))') and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("static func configure_topup_card") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").count('type="Panel" parent="Window/Lots/') == 4 and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").count('type="Panel" parent="Window/Lots/') == 3 and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").count("anchors_preset = 7") == 4 and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").count("anchors_preset = 7") == 3 and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("button.icon_alignment = HORIZONTAL_ALIGNMENT_CENTER") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").contains("separation = -49") and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").contains("separation = -58") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("button.clip_contents = true") and not FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("COIN_LOTS") and not FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("ENERGY_LOTS") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains('button.text = "FREE"') and FileAccess.get_file_as_string("res://src/presentation/main/energy_hud.tscn").contains("Next energy in 02:00") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").contains("visible = false\nlayout_mode = 0\noffset_left = 250.0") and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").contains("visible = false\nlayout_mode = 0\noffset_left = 150.0"), "wallet HUD: stable hover, visible price content, hidden balances, and corrected lot spacing are required")
