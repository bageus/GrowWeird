...
func _test_scene_hud_contract() -> void:
	...
	_expect(shop_script.contains("UiAtlas.coin_texture()") and shop_script.contains("configure_button(buy_button, 7, 1)") and shop_script.contains("TransactionDialogVisual.configure"), "shop HUD: atlas Buy and close controls are missing")
