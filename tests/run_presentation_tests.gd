...
func _test_growth_stage_geometry() -> void:
	...
	_expect(flower_editor != null and FileAccess.file_exists("res://content/visual/tree_flower_layouts.json") and FileAccess.get_file_as_string("res://src/presentation/main/flower_layout_editor.gd").contains("RIPE_FRUIT"), "flower layout: independent editor and storage are missing")
