...
func _test_scene_hud_contract() -> void:
	...
	_expect(shop_scene.contains("ItemGrid") and shop_scene.contains("HoverDescription") and shop_scene.contains("Confirm"), "shop HUD: item grid, hover description, or purchase confirmation is missing")
