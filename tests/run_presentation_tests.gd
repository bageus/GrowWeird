...
func _test_inventory_hud_contract() -> void:
	...
	_expect(not dialogs_text.contains("CancelAction") and FileAccess.get_file_as_string("res://src/presentation/main/scene_controls_overlay.gd").contains("dialogs.needs_scene_cancel()") and inventory_script.contains("context_cancel_requested") and inventory_script.contains("ContextCancelCaption") and inventory_script.contains("ContextCancelCell") and inventory_script.contains("face.offset_left = 12.0"), "inventory HUD: selected item must become the matching Cancel button")
	...
	_expect(FileAccess.get_file_as_string("res://src/presentation/main/scene_controls_overlay.gd").contains("set_energy_topup_visible(false)") and FileAccess.get_file_as_string("res://src/presentation/main/scene_controls_overlay.gd").contains("set_wallet_topup_visible(false)") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.gd").contains('curved_title($Window/MenuTitle, "COINS")') and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.gd").contains('curved_title($Window/MenuTitle, "ENERGY")') and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("CommerceUiStyle.topup_button") and FileAccess.get_file_as_string("res://src/presentation/ui/commerce_ui_style.gd").contains("_topup_style") and FileAccess.get_file_as_string("res://src/presentation/ui/commerce_ui_style.gd").contains("set_corner_radius_all(13)") and FileAccess.get_file_as_string("res://src/presentation/ui/commerce_ui_style.gd").contains("shadow_offset = Vector2(0.0, depth)") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("RUBLE_ICON") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("DOLLAR_ICON") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("BALANCE_PLUS_ICON") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains('center.name = "PriceContent"') and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains('&"separation", 5') and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("button.offset_left = -88.0") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains('card_style.bg_color = Color("ffd078")') and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").contains("offset_left = -96.0") and FileAccess.get_file_as_string("res://src/presentation/main/energy_hud.tscn").contains("offset_left = 48.0\noffset_top = 77.0\noffset_right = 218.0"), "wallet HUD: switching, curved titles, programmatic buttons, and timer placement are required")
	_expect(main_screen_script.contains("func _input(event: InputEvent)") and FileAccess.get_file_as_string("res://src/presentation/main/scene_controls_overlay.gd").contains("cancelable_menu_contains_global_point") and main_screen_script.contains("set_input_as_handled") and main_screen_script.contains("set_prune_cancel(mode == PlantView.MODE_PRUNE)") and main_screen_script.contains("_interaction_mode == PlantView.MODE_PRUNE: _on_cancel_pressed()") and main_screen_script.contains('action_id != &"prune": _cancel_action()') and FileAccess.get_file_as_string("res://src/presentation/main/scene_controls_overlay.gd").contains("face.offset_left = 20.0") and FileAccess.get_file_as_string("res://src/presentation/main/scene_controls_overlay.gd").contains("ContextCancelButton") and FileAccess.get_file_as_string("res://src/presentation/main/scene_controls_overlay.gd").contains("ContextCancelCaption") and FileAccess.get_file_as_string("res://src/presentation/inventory/inventory_hud.gd").contains("context_cancel_requested"), "context menus: outside click and activator buttons must provide matching cancel behavior")
