...
func _test_inventory_hud_contract() -> void:
	...
	_expect(main_scene_text.contains("CareGauge") and main_scene_text.contains("care_gauge.gd") and FileAccess.get_file_as_string("res://src/presentation/main/care_gauge.gd").contains("_bar_style") and FileAccess.get_file_as_string("res://src/presentation/main/care_gauge.gd").contains("var shine") and FileAccess.get_file_as_string("res://src/presentation/main/care_gauge.gd").contains("AUTO_HIDE_SECONDS") and FileAccess.get_file_as_string("res://src/presentation/main/care_gauge.gd").contains('Color("ef3f36")') and FileAccess.get_file_as_string("res://src/presentation/main/tree_growth_preview.gd").contains("tree_hover_changed"), "care HUD: three-arc gauge is missing from the main scene")
	...
	_expect(controls_scene.contains("layout_id = &\"wallet\"\ndrag_handle_height = 120.0\nallow_scaling = true") and controls_scene.contains("z_index = 200") and FileAccess.get_file_as_string("res://src/presentation/main/energy_hud.tscn").contains("z_index = 200") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("configure_balance_hud") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("Vector2(39.0, 39.0)") and controls_scene.contains('name="BalanceArt" type="Panel"') and FileAccess.get_file_as_string("res://src/presentation/main/energy_hud.tscn").contains('name="BalanceArt" type="Panel"'), "balance HUD: coin and energy blocks must be scalable and above dialogs")
	...
	_expect(main_screen_script.contains("func _input(event: InputEvent)") and FileAccess.get_file_as_string("res://src/presentation/main/scene_controls_overlay.gd").contains("cancelable_menu_contains_global_point") and main_screen_script.contains("set_input_as_handled") and FileAccess.get_file_as_string("res://src/presentation/main/scene_controls_overlay.gd").contains("ContextCancelButton") and FileAccess.get_file_as_string("res://src/presentation/main/scene_controls_overlay.gd").contains("ContextCancelCaption") and FileAccess.get_file_as_string("res://src/presentation/inventory/inventory_hud.gd").contains("context_cancel_requested"), "context menus: outside click and activator buttons must provide matching cancel behavior")
