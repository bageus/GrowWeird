...
func _test_scene_hud_contract() -> void:
	...
	_expect(hud_text.contains("OffersPanel") and hud_text.contains("RefreshOffer") and hud_text.contains("SkipOffer") and hud_text.contains("AdOffer") and hud_text.contains("FertilizerAuxiliaryUi") and FileAccess.get_file_as_string("res://src/presentation/main/fertilizer_auxiliary_ui.tscn").contains('name="Dim"'), "scene HUD: fertilizer modal, dim, timer, journal, and actions must be persistent scene nodes")
