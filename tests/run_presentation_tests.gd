...
func _test_inventory_hud_contract() -> void:
	...
	_expect(draggable_script.contains("KEY_CTRL") and draggable_script.contains("MOUSE_BUTTON_WHEEL_UP") and draggable_script.contains("scale_committed.emit") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.gd").contains('configure_topup_card(%Coin1000, "1000 Coins", UiAtlas.energy_coin_icon(1, 4))') and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.gd").contains('configure_topup_card(%Energy30, "30 Energy", UiAtlas.energy_coin_icon(3, 4))') and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("static func configure_topup_card") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").count('type="Panel" parent="Window/Lots/') == 4 and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").count('type="Panel" parent="Window/Lots/') == 3 and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").count("anchors_preset = 7") == 4 and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").count("anchors_preset = 7") == 3 and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("button.icon_alignment = HORIZONTAL_ALIGNMENT_CENTER") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").contains("separation = 8") and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").contains("separation = 8") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("button.clip_contents = true") and not FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("COIN_LOTS") and not FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("ENERGY_LOTS") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains('button.text = "FREE"') and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").contains("Vector2(195, 330)") and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").contains("Vector2(213.2, 330)") and not FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").contains("Advertising bonus") and FileAccess.get_file_as_string("res://src/presentation/main/energy_hud.tscn").contains("Next energy in 02:00") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").contains("visible = false\nlayout_mode = 0\noffset_left = 250.0") and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").contains("visible = false\nlayout_mode = 0\noffset_left = 150.0"), "wallet HUD: stable hover, visible price content, hidden balances, and corrected lot spacing are required")
