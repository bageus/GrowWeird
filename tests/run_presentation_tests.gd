...
func _test_scene_hud_contract() -> void:
	...
	_expect(hud_text.contains('name="PotCircle" type="Panel"') and hud_text.contains('name="PreviousPot" type="Button" parent="PotSelector/Layers"') and FileAccess.get_file_as_string("res://src/presentation/main/scene_controls_overlay.gd").contains("_configure_pot_circle") and FileAccess.get_file_as_string("res://src/presentation/main/scene_controls_overlay.gd").contains('gloss.name = "Gloss"'), "scene HUD: pot circle must stay square with arrows outside")
...
func _test_inventory_hud_contract() -> void:
	...
	_expect(not dialogs_text.contains("CancelAction") and FileAccess.get_file_as_string("res://src/presentation/main/scene_controls_overlay.gd").contains("dialogs.needs_scene_cancel()") and inventory_script.contains("context_cancel_requested") and inventory_script.contains("ContextCancelCaption"), "inventory HUD: selected item must become the matching Cancel button")
