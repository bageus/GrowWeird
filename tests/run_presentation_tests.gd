...
func _test_inventory_hud_contract() -> void:
	...
	_expect(draggable_script.contains("KEY_CTRL") and draggable_script.contains("MOUSE_BUTTON_WHEEL_UP") and draggable_script.contains("scale_committed.emit") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.gd").contains("UiAtlas.COIN_LOTS[1000]") and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.gd").contains("UiAtlas.ENERGY_LOTS[30]") and not FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("static func coin_lot") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").count("scale = Vector2(2.6, 2.6)") == 4 and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").count("scale = Vector2(2.6, 2.6)") == 3 and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").count("anchors_preset = 7") == 4 and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").count("anchors_preset = 7") == 3 and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("button.icon_alignment = HORIZONTAL_ALIGNMENT_CENTER") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").contains("separation = -61") and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").contains("separation = -72") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("button.clip_contents = true") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("var content := HBoxContainer.new()") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("Vector2(84.0, 84.0)") and FileAccess.get_file_as_string("res://src/presentation/main/energy_hud.tscn").contains("Next energy in 02:00") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("Vector2(42.0, 0.0)") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").contains("visible = false\nlayout_mode = 0\noffset_left = 250.0") and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").contains("visible = false\nlayout_mode = 0\noffset_left = 150.0"), "wallet HUD: stable hover, visible price content, hidden balances, and corrected lot spacing are required")
