...
func _test_scene_hud_contract() -> void:
	...
	_expect(FileAccess.get_file_as_string("res://src/presentation/main/scene_controls_overlay.gd").count("configure_warm_timer_hud") == 2 and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("static func warm_hud_style") and not FileAccess.get_file_as_string("res://src/presentation/main/energy_hud.tscn").contains("NextArt"), "scene HUD: shared programmatic timer HUD style is missing")
	...
	_expect(hud_text.contains('instance=ExtResource("4_shop")') and hud_text.contains("z_index = 100"), "shop HUD: modal shop must render above every scene control")
	...
	_expect(FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").contains('[node name="Background" type="Panel" parent="Window"]') and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").contains('[node name="Background" type="Panel" parent="Window"]') and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.gd").contains("UiAtlas.configure_close_button(%CloseButton)") and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.gd").contains("UiAtlas.configure_close_button(%CloseButton)"), "top-up HUD: programmatic warm panels and visible close buttons are required")
	_expect(shop_scene.contains('[node name="ConfirmBackground" type="Panel" parent="Confirm"]') and shop_script.contains("warm_hud_style(8, 26") and FileAccess.get_file_as_string("res://src/presentation/inventory/inventory_item_dialogs.tscn").contains('[node name="SellBackground" type="Panel" parent="SellPopup"]') and FileAccess.get_file_as_string("res://src/presentation/inventory/inventory_item_dialogs.gd").contains("warm_hud_style(8, 26"), "transaction HUD: purchase and sale confirmations must use framed programmatic panels")
	...
	_expect(shop_script.contains("UiAtlas.coin_texture()") and shop_script.contains("configure_button(buy_button, 7, 1)") and shop_script.contains("configure_close_button(%ConfirmClose)"), "shop HUD: atlas Buy and close controls are missing")
...
func _test_inventory_hud_contract() -> void:
	...
	_expect(FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").contains('[node name="WalletTopupPanel" type="Control"]\nvisible = false') and controls_scene.count("z_index = 180") == 2 and FileAccess.get_file_as_string("res://src/presentation/shop/shop_panel.tscn").contains('[node name="Confirm" type="Control" parent="."]\nunique_name_in_owner = true\nz_index = 80') and dialogs_text.contains('[node name="SellPopup" type="Control" parent="."]\nvisible = false\nz_index = 160'), "modal HUD: top-ups and transaction confirmations must stay below balances and above other UI")
	_expect(draggable_script.contains("KEY_CTRL") and draggable_script.contains("MOUSE_BUTTON_WHEEL_UP") and draggable_script.contains("scale_committed.emit") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.gd").contains("UiAtlas.COIN_LOTS[1000]") and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.gd").contains("UiAtlas.ENERGY_LOTS[30]") and not FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("static func coin_lot") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").count("scale = Vector2(2, 2)") == 4 and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").count("scale = Vector2(2, 2)") == 3 and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").count("anchors_preset = 7") == 4 and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").count("anchors_preset = 7") == 3 and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("button.icon_alignment = HORIZONTAL_ALIGNMENT_CENTER") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").contains("separation = -42") and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").contains("separation = -45") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("button.clip_contents = true") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("var content := HBoxContainer.new()") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("Vector2(84.0, 84.0)") and FileAccess.get_file_as_string("res://src/presentation/main/energy_hud.tscn").contains("Next energy in 02:00") and FileAccess.get_file_as_string("res://src/presentation/ui/ui_atlas.gd").contains("Vector2(42.0, 0.0)") and FileAccess.get_file_as_string("res://src/presentation/main/wallet_topup_panel.tscn").contains("visible = false\nlayout_mode = 0\noffset_left = 250.0") and FileAccess.get_file_as_string("res://src/presentation/main/energy_topup_panel.tscn").contains("visible = false\nlayout_mode = 0\noffset_left = 150.0"), "wallet HUD: stable hover, visible price content, hidden balances, and corrected lot spacing are required")
