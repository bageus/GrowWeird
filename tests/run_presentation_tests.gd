...
func _test_inventory_hud_contract() -> void:
	...
	_expect(main_scene_text.contains("CareGauge") and main_scene_text.contains("care_gauge.gd") and FileAccess.get_file_as_string("res://src/presentation/main/care_gauge.gd").contains("_bar_style") and FileAccess.get_file_as_string("res://src/presentation/main/care_gauge.gd").contains("var shine"), "care HUD: three-arc gauge is missing from the main scene")
