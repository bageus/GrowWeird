...
func _test_scene_hud_contract() -> void:
	...
	_expect(shop_scene.contains('name="Balance" type="PanelContainer"') and shop_scene.contains("ShopBalanceIcon") and shop_scene.contains("BalancePlus") and shop_scene.contains("anchor_top = 0.2") and shop_script.contains("warm_hud_style(5, 24"), "shop HUD: programmatic frame, local balance, or safe top offset is missing")
