...
static func icon_badge_style() -> StyleBoxFlat:
	var style := CommerceUiStyle.top_hud_style(28); style.shadow_size = 0; style.shadow_offset = Vector2.ZERO; style.bg_color = Color("d97716"); style.border_color = Color("ffb51b"); style.set_border_width_all(3); return style
