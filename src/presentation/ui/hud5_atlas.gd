...
static func region(row: int, column: int, columns: int) -> Texture2D:
...
static func fertilizer_finish_pressed_icon() -> Texture2D: return region(3, 1, 2)
static func cycle_finish_icon() -> Texture2D: return region(3, 3, 2)
static func cycle_finish_hover_icon() -> Texture2D: return region(3, 3, 2)
static func cycle_finish_pressed_icon() -> Texture2D: return region(3, 3, 2)
...
static func add_cost_overlay(button: Button) -> Label:
	...
	dot.position = Vector2(button.size.x * 0.58, 0.0)
	...
	label.position = Vector2(button.size.x * 0.70, 0.0)
	label.size = Vector2(button.size.x * 0.27, button.size.y)
