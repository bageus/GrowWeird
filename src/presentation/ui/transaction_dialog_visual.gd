...
const CLOSE_RECT := Rect2(438.0, -10.0, 60.0, 60.0)
...
static func configure(nodes: Dictionary, mode: StringName, action_frame: Vector2i) -> void:
	...
	_set_rect(nodes["minus"] as Control, Rect2(8.0, 8.0, 54.0, 54.0))
	_set_rect(nodes["quantity_label"] as Control, Rect2(70.0, 4.0, 260.0, 62.0))
	_set_rect(nodes["plus"] as Control, Rect2(338.0, 8.0, 54.0, 54.0))
