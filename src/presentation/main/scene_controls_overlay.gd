...
func _set_context_cancel_state(button: Button, active: bool) -> void:
	...
	button.add_child(face); face.set_anchors_and_offsets_preset(Control.PRESET_FULL_RECT); face.offset_left = 4.0; face.offset_top = 13.0; face.offset_right = -36.0; face.offset_bottom = -17.0
