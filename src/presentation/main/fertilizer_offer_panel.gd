...
func _configure_timer_hud() -> void:
	_timer.size = Vector2(HUD_WIDTH, 42.0); _timer_label.position = Vector2(34.0, 0.0); _timer_label.size = Vector2(102.0, 42.0); _timer_label.horizontal_alignment = HORIZONTAL_ALIGNMENT_CENTER; _timer_label.vertical_alignment = VERTICAL_ALIGNMENT_CENTER
