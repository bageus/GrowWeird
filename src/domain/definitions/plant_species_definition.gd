...
@export_range(0.0, 1.0, 0.01) var nutrition_min: float = 0.3
@export_range(0.0, 1.0, 0.01) var nutrition_max: float = 0.75
...
@export_range(0.0, 0.01, 0.00001) var nutrition_decay_per_second: float = 0.00012
